...
compat-transfer : (P : ProductRule) → Compat′ P → Compat P
compat-transfer P eq c =
    begin
        [ P ]⟨ c · x , c · x′ , y , y′ ⟩
...
open import Special.DecidableEquivalence-Integral R
...
module HadamardSpecial where
    ...
    special = record
        ...
        ; P-compat = compat-transfer P (fst P-compat-special)
        }
