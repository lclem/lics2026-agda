...
```
δʳ-Δʳ : Set
δʳ-Δʳ = ∀ {i} b α → δʳ b (S ⟦ α ⟧) ≈[ i ] S ⟦ Δʳ b ↑ α ⟧
```
...
δʳP→δʳ-Δʳ ass b (α [+] β) =
    begin
        ...
        δʳ b (S ⟦ α ⟧ + S ⟦ β ⟧)
            ≈⟨ δʳ-end-+ _ _ _ ⟩
        δʳ b (S ⟦ α ⟧) + δʳ b (S ⟦ β ⟧)
            ≈⟨ δʳP→δʳ-Δʳ ass _ _ ⟨ +-cong ⟩ δʳP→δʳ-Δʳ ass _ _ ⟩
        S ⟦ Δʳ b ↑ α ⟧ + S ⟦ Δʳ b ↑ β ⟧
            ≈⟨ sem-+ S ⟨
        S ⟦ Δʳ b ↑ (α [+] β) ⟧
    ∎ where open EqS

δʳP→δʳ-Δʳ ass b (α [*] β) with δʳP→δʳ-Δʳ ass b α | δʳP→δʳ-Δʳ ass b β
... | ass-α | ass-β =
    begin
        δʳ b (S ⟦ α [*] β ⟧)
            ≈⟨ δʳ-cong b (sem-* S) ⟩
...
```
δʳ-Δʳ→Δʳ-Δˡ : δʳ-Δʳ → Δʳ-Δˡ
δʳ-Δʳ→Δʳ-Δˡ ass a b α =
    begin
...
δʳ-Δʳ-ν b (var (u x[ f ] v)) = EqR.≡→≈ (δʳ-Δʳ-ν-var b u f v)
...
δʳ-Δʳ-ν b (α [+] β) =
    begin
        ...
        ν (δʳ b (S ⟦ α ⟧ + S ⟦ β ⟧)) ≈⟨⟩ 
        ν (δʳ b (S ⟦ α ⟧) + δʳ b (S ⟦ β ⟧)) ≈⟨⟩ 
        ν (δʳ b (S ⟦ α ⟧)) +R ν (δʳ b (S ⟦ β ⟧)) ≈⟨ δʳ-Δʳ-ν b α ⟨ +R-cong ⟩ δʳ-Δʳ-ν b β ⟩
...
We can finally show that `Δʳ-Δˡ` implies `δʳ-Δʳ`.

```
Δʳ-Δˡ→δʳ-Δʳ : Δʳ-Δˡ → δʳ-Δʳ
ν-≈ (Δʳ-Δˡ→δʳ-Δʳ _ b α) = δʳ-Δʳ-ν b α
δ-≈ (Δʳ-Δˡ→δʳ-Δʳ ass b α) a =
    begin
        δˡ a (δʳ b (S ⟦ α ⟧)) ≈⟨⟩
        δʳ b (δˡ a (S ⟦ α ⟧)) ≈⟨⟩
        δʳ b (S ⟦ Δˡ a ↑ α ⟧) ≈⟨ Δʳ-Δˡ→δʳ-Δʳ ass b (Δˡ a ↑ α) ⟩
